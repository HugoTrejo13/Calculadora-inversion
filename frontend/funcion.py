...
"""
LEGACY UI (referencia visual)
--------------------------------
Este archivo contiene la versión monolítica original de la app:
- textos de ayuda
- lógica de tabs
- i18n (LANGUAGES)
- sliders, formularios, tablas

Ya NO es la app principal en runtime.
La app principal vive en:
    frontend/screens/app_main.py  (clase App)
    frontend/screens/*.py         (pantallas/tab separadas)
    frontend/components/*.py      (componentes reusables)

No borres este archivo todavía.
